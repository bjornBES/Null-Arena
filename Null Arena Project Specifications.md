...
> **Purpose:** Defines the structure, uses and definitions of the Null Arena project and all it's software.
...
Here are the definitions of what Null Arena is, if any of these definitions are broken and or are not done with good faith in mind, then the Null Arena software and servers is no longer apart of the Bare Spirit Project.
